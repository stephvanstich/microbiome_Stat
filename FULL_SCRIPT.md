...
```
```
KW_Verruco_test_mothers_ADI1x_Ctrl_p_value<-KW_Verruco_test_mothers_ADI1x_Ctrl$p.value 
KW_Verruco_test_mothers_ADI2x_Ctrl_p_value<-KW_Verruco_test_mothers_ADI2x_Ctrl$p.value 
KW_Verruco_test_pups_ADI1x_Ctrl_p_value<-KW_Verruco_test_pups_ADI1x_Ctrl$p.value 
KW_Verruco_test_pups_ADI2x_Ctrl_p_value<- KW_Verruco_test_pups_ADI2x_Ctrl$p.value

KW_Tenericut_test_mothers_ADI1x_Ctrl_p_value<- KW_Tenericut_test_mothers_ADI1x_Ctrl$p.value
KW_Tenericut_test_mothers_ADI1x_Ctrl_p_value<- KW_Tenericut_test_mothers_ADI1x_Ctrl$p.value
KW_Tenericut_test_pups_ADI1x_Ctrl_p_value<- KW_Tenericut_test_pups_ADI1x_Ctrl$p.value
KW_Tenericut_test_pups_ADI2x_Ctrl_p_value<- KW_Tenericut_test_pups_ADI2x_Ctrl$p.value

KW_Unassigned_test_mothers_ADI1x_Ctrl_p_value<- KW_Unassigned_test_mothers_ADI1x_Ctrl$p.valuee
KW_Unassigned_test_mothers_ADI2x_Ctrl_p_value<- KW_Unassigned_test_mothers_ADI2x_Ctrl$p.value
KW_Unassigned_test_pups_ADI1x_Ctrl_p_value<- KW_Unassigned_test_pups_ADI1x_Ctrl$p.value
KW_Unassigned_test_pups_ADI2x_Ctrl_p_value<- KW_Unassigned_test_pups_ADI2x_Ctrl$p.value

KW_Bacteroidetes_test_mothers_ADI1x_Ctrl_p_value<- KW_Bacteroidetes_test_mothers_ADI1x_Ctrl$p.value
KW_Bacteroidetes_test_mothers_ADI2x_Ctrl_p_value<- KW_Bacteroidetes_test_mothers_ADI2x_Ctrl$p.value
KW_Bacteroidetes_test_pups_ADI1x_Ctrl_p_value<- KW_Bacteroidetes_test_pups_ADI1x_Ctrl$p.value
KW_Bacteroidetes_test_pups_ADI2x_Ctrl_p_value<- KW_Bacteroidetes_test_pups_ADI2x_Ctrl$p.value

KW_Firmicutes_test_mothers_ADI1x_Ctrl_p_value<- KW_Firmicutes_test_mothers_ADI1x_Ctrl$p.value
KW_Firmicutes_test_mothers_ADI2x_Ctrl_p_value<- KW_Firmicutes_test_mothers_ADI2x_Ctrl$p.value
KW_Firmicutes_test_pups_ADI1x_Ctrl_p_value<- KW_Firmicutes_test_pups_ADI1x_Ctrl$p.value
KW_Firmicutes_test_pups_ADI2x_Ctrl_p_value<- KW_Firmicutes_test_pups_ADI2x_Ctrl$p.value

KW_Proteobacteria_test_mothers_ADI1x_Ctrl_p_value<- KW_Proteobacteria_test_mothers_ADI1x_Ctrl$p.value
KW_Proteobacteria_test_mothers_ADI2x_Ctrl_p_value<- KW_Proteobacteria_test_mothers_ADI2x_Ctrl$p.value
KW_Proteobacteria_test_pups_ADI1x_Ctrl_p_value<- KW_Proteobacteria_test_pups_ADI1x_Ctrl$p.value
KW_Proteobacteria_test_pups_ADI2x_Ctrl_p_value<- KW_Proteobacteria_test_pups_ADI2x_Ctrl$p.value
```
