...
BE CAREFUL: to have THE TAXA IN THE SAME column ORDER or re-order the rows after your stat analysis that they are all in the same order. this is important for both the correlation and the statistical test!
